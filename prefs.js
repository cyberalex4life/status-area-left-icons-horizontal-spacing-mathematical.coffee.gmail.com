...
const StatusAreaLeftIconsHorizontalSpacingPrefsWidget = new GObject.Class({
    Name: 'StatusAreLeftIconsaHorizontalSpacing.Prefs.Widget',
    GTypeName: 'StatusAreaLeftIconsHorizontalSpacingPrefsWidget',
    Extends: Gtk.Grid,
...
function buildPrefsWidget() {
    let widget = new StatusAreaLeftIconsHorizontalSpacingPrefsWidget();
    widget.show_all();
